...
uint32_t wordNibbleSwap(uint32_t toSwap)
{
	return  ((toSwap & 0x00000F)<<4) | ((toSwap & 0x0000F0)>>4) |
			((toSwap & 0x000F00)<<4) | ((toSwap & 0x00F000)>>4) |
			((toSwap & 0x0F0000)<<4) | ((toSwap & 0xF00000)>>4);
}
