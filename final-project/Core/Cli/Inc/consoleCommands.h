...
#ifndef CLI_SRC_CONSOLECOMMANDS_H_
#define CLI_SRC_CONSOLECOMMANDS_H_
...
#define CONSOLE_COMMAND_MAX_HELP_LENGTH 100			// if this is zero, there will be no  help (XXXOPT: RAM reduction)
